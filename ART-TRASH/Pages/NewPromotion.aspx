<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewPromotion.aspx.cs" Inherits="ArtTrash.Pages.NewPromotion" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-8">
                                    <asp:DropDownList ID="ddProducts" class="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-4">
                                    <asp:TextBox ID="txQuantity" runat="server" type="number" class="form-control w-auto" placeholder="Cantidad"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-6 ">
                                    <asp:Button ID="btAdd" runat="server" class="btn btn-secondary btn-sm w-100" Text="Añadir" Width="300" OnClick="btAdd_Click" />
                                </div>
                                <div class="col-6 ">
                                    <asp:Button ID="btSave" runat="server" class="btn btn-dark btn-sm w-100" Text="Guardar Promoción" Width="300" OnClick="btSave_Click" />
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-12">
