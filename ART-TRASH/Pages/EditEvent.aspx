<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEvent.aspx.cs" Inherits="ArtTrash.Pages.EditEvent" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Button ID="btEditar" runat="server" Text="Editar" class="btn btn-info w-100" OnClick="btEditar_Click" OnClientClick="if(this.value === ' Editar ') { return false; } else { this.value = ' Editar '; }" />
