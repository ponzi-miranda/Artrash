...
{
    public partial class AdminEditPromotion : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    if (Request.QueryString["id"] != null)
                    {
                        ...
                        List<ProductsDTO> products = ServiceHelper.ws.GetProductsByBrandID(promotion.idBrand).ToList();
                        ...
                        txBrand.Text = ServiceHelper.ws.GetBrandByID(promotion.idBrand).name;
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PromotionsDTO promotion = ServiceHelper.ws.GetPromotionById(Convert.ToInt32(Request.QueryString["id"]));
                promotion.description = txDescription.Text;
                promotion.state = "ACTIVO";
                promotion.price = Convert.ToDecimal(txPrice.Text);
                promotion.idBrand = promotion.idBrand;
                ...
                foreach (var product in products)
                {
                    ...
                    productsPromo.idPromotion = promotion.Id;
