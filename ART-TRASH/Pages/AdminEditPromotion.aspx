<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminEditPromotion.aspx.cs" Inherits="ArtTrash.Pages.AdminEditPromotion" %>
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive small">
                                        <asp:GridView ID="gvProducts" runat="server" DataKeyNames="Id" CssClass="small table table-sm table-hover main-table w-100 table-responsive small " ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" OnRowCommand="gvProducts_RowCommand">
                                            <Columns>
