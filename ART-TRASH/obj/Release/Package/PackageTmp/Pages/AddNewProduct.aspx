<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewProduct.aspx.cs" Inherits="ArtTrash.Pages.AddNewProduct" %>
            ...
            <div class="container mt-5">
                <div class="row">                  
                    ...
                    <div class="col-lg-4">
                            ...
                            <asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="ddBrands" InitialValue="Seleccione" ErrorMessage="Seleccione una opción (*)" />
                            <br />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Button ID="btCrear" runat="server" Text="Crear" class="btn btn-dark w-100" OnClick="btCrear_Click"/>
