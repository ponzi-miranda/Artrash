<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TotalEventMetrics.aspx.cs" Inherits="ArtTrash.Pages.TotalEventMetrics" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h4>Total rentabilidad/ventas:</h4>                    
                                ...
                                <div class="col-12">
                                     <div class="table-responsive small"><asp:GridView ID="gvSales" runat="server" CssClass="small table table-sm table-hover main-table w-100 table-responsive small " AutoGenerateColumns="false" DataKeyNames="Id" ShowHeaderWhenEmpty="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="TIPO" DataField="type_total" />
