<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PercentageProfitMetrics.aspx.cs" Inherits="ArtTrash.Pages.PercentageProfitMetrics" %>
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-8 pb-3">
                             <h4>Reporte Rentabildad por marcas:</h4>
                            </div>
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h4>Rentabilidad en Eventos:</h4>
                                       <asp:Chart ID="Chart1" runat="server" Height="500px" Width="500px">
                                        <legends>
                                            <asp:Legend Alignment="Center" Docking="Top" LegendStyle="Table" TitleFont="Microsoft Sans Serif, 8pt, style=Bold" BackColor="Transparent" Font="Trebuchet MS, 8.25pt, style=Bold" IsTextAutoFit="False" Enabled="True" Name="Default"></asp:Legend>
                                        </legends>
                                        <series>
                                        </series>
                                        <chartareas>
                                   ...
                                   <div class="col-12">
                                     <div class="table-responsive small"><asp:GridView ID="gvProfit" runat="server" CssClass="small table table-sm table-hover main-table w-100 table-responsive small " AutoGenerateColumns="false" DataKeyNames="Id" ShowHeaderWhenEmpty="true">
                                        <Columns>                                            
                                            <asp:BoundField HeaderText="#" DataField="Id" />
                                            <asp:BoundField HeaderText="EVENTO" DataField="event_name" />
                                            <asp:BoundField HeaderText="MARCA" DataField="brand_name" />
                                            <asp:BoundField HeaderText="TOTAL VENTAS" DataField="total" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign ="Right"/>
                                            <asp:BoundField HeaderText="TOTAL RENTABILIDAD" DataField="profit" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign ="Right"/>
                                        </Columns>
                                        <EmptyDataTemplate>
