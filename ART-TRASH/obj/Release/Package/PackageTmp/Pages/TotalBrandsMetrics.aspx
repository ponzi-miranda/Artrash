<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TotalBrandsMetrics.aspx.cs" Inherits="ArtTrash.Pages.TotalBrandsMetrics" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <h4>Reporte Totales por marcas:</h4>
                            </div>
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h4>Totales Marcas en Eventos:</h4>
                                       <asp:Chart ID="Chart1" runat="server" Height="500px" Width="500px">
                                        <legends>
                                            <asp:Legend Alignment="Center" Docking="Bottom" LegendStyle="Table" TitleFont="Microsoft Sans Serif, 8pt, style=Bold" BackColor="Transparent" Font="Trebuchet MS, 8.25pt, style=Bold" IsTextAutoFit="False" Enabled="True" Name="Default"></asp:Legend>
                                        </legends>
                                        <series>
                                        </series>
                                        <chartareas>
                                   ...
                                   <div class="col-12">
                                     <div class="table-responsive small"><asp:GridView ID="gvProfit" runat="server" CssClass="small table table-sm table-hover main-table w-100 table-responsive small " AutoGenerateColumns="false" DataKeyNames="Id" ShowHeaderWhenEmpty="true">
                                        <Columns>                                            
                                            ...
                                            <asp:BoundField HeaderText="DENOMINACION" DataField="denomination" />
                                            <asp:BoundField HeaderText="TOTAL" DataField="profit" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign ="Right"/>
                                        </Columns>
                                        <EmptyDataTemplate>
