<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="ArtTrash.Pages.EditProduct" %>
                ...
                <div class="row">                  
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Button ID="btEditar" runat="server" Text="Guardar" class="btn btn-dark w-100" OnClick="btEditar_Click" />
